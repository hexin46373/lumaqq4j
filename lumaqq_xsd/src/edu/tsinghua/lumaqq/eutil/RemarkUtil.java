...
public class RemarkUtil {
	...
	public static final void save(File file, Remarks remarks) {
        ...
        resourceSet.getPackageRegistry().put(RemarkPackage.eINSTANCE.getNsURI(), RemarkPackage.eINSTANCE);
        ...
        resource.getContents().add(remarks);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static final Remarks load(File file) {
        // Create a resource set.
        ResourceSet resourceSet = new ResourceSetImpl();
        ...
        try {
	        ...
	        if(resource.getContents().isEmpty())
	        	...
	        	return (Remarks) resource.getContents().get(0);
		} catch (IOException e) {
			return null;
		}
	}
	 ...
	 * 		缺省的登录历史文件根元素对象
	 */
	public static final Remarks createDefault() {
		Remarks remarks = RemarkFactory.eINSTANCE.createRemarks();
		return remarks;
	}
}
