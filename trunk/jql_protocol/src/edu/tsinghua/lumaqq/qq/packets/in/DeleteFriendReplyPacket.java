...
@DocumentalPacket
@PacketName("删除好友回复包")
@RelatedPacket({DeleteFriendPacket.class})
@LinkedEvent({QQ_DELETE_FRIEND_SUCCESS, QQ_DELETE_FRIEND_FAIL})
public class DeleteFriendReplyPacket extends BasicInPacket {
     ...
     */
    public DeleteFriendReplyPacket(ByteBuffer buf, int length, QQUser user) throws PacketParseException {
