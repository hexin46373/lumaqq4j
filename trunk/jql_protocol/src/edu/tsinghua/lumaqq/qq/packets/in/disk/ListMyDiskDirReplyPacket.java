 ...
 */
@DocumentalPacket
@PacketName("获取我的网络硬盘目录列表回复包")
@RelatedPacket({ListMyDiskDirPacket.class})
@LinkedEvent({QQ_DISK_GET_MY_DISK_DIR_SUCCESS})
public class ListMyDiskDirReplyPacket extends DiskInPacket {
	...
	public ListMyDiskDirReplyPacket(ByteBuffer buf, int length, QQUser user) throws PacketParseException {
		super(buf, length, user);
	}
	
	@Override
	public String getPacketName() {
		return "List My Disk Dir Reply Packet";
	}
