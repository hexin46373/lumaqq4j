...
@DocumentalPacket
@PacketName("获取密钥请求包")
@RelatedPacket({RequestKeyReplyPacket.class})
public class RequestKeyPacket extends BasicOutPacket {    
     ...
     */
    public RequestKeyPacket(ByteBuffer buf, int length, QQUser user)
            throws PacketParseException {
