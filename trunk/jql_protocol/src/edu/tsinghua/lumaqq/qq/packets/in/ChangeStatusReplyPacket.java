...
@DocumentalPacket
@PacketName("改变状态回复包")
@RelatedPacket({ChangeStatusPacket.class})
@LinkedEvent({QQ_CHANGE_STATUS_SUCCESS, QQ_CHANGE_STATUS_FAIL})
public class ChangeStatusReplyPacket extends BasicInPacket {
     ...
     */
    public ChangeStatusReplyPacket(ByteBuffer buf, int length, QQUser user) throws PacketParseException {
