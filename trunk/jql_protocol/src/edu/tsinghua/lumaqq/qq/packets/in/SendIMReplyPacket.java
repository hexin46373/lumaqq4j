...
@DocumentalPacket
@PacketName("发送消息回复包")
@RelatedPacket({SendIMPacket.class})
@LinkedEvent({QQ_SEND_IM_SUCCESS, QQ_SEND_FILE_REQUEST_SEND_SUCCESS})
public class SendIMReplyPacket extends BasicInPacket {
     ...
     */
    public SendIMReplyPacket(ByteBuffer buf, int length, QQUser user) throws PacketParseException {
