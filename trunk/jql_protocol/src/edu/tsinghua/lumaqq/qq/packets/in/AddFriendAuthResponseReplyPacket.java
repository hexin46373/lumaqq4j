 ...
 */
@DocumentalPacket
@PacketName("好友认证处理确认包")
@RelatedPacket({AddFriendAuthResponsePacket.class})
@LinkedEvent({QQEvent.QQ_ADD_FRIEND_AUTH_SEND_SUCCESS, QQEvent.QQ_ADD_FRIEND_AUTH_SEND_FAIL})
