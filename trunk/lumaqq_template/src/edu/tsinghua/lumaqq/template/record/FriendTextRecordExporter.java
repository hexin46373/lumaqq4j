...
public class FriendTextRecordExporter implements IRecordExporter {
  protected static String nl;
  public static synchronized FriendTextRecordExporter create(String lineSeparator)
  {
    nl = lineSeparator;
    FriendTextRecordExporter result = new FriendTextRecordExporter();
    nl = null;
    return result;
  }
	...
	public String generate(Object argument)
  {
    ...
    stringBuffer.append( friend.qq );
    stringBuffer.append(TEXT_4);
    stringBuffer.append( friend.displayName );
