...
public class HtmlRecordExporter implements IRecordExporter {
  protected static String nl;
  public static synchronized HtmlRecordExporter create(String lineSeparator)
  {
    nl = lineSeparator;
    HtmlRecordExporter result = new HtmlRecordExporter();
    nl = null;
    return result;
  }
