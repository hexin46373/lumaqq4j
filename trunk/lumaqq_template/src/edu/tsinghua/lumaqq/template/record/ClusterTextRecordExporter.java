...
public class ClusterTextRecordExporter implements IRecordExporter {
  protected static String nl;
  public static synchronized ClusterTextRecordExporter create(String lineSeparator)
  {
    nl = lineSeparator;
    ClusterTextRecordExporter result = new ClusterTextRecordExporter();
    nl = null;
    return result;
  }
