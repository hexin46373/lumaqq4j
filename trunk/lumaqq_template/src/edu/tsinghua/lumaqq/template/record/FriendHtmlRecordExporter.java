...
public class FriendHtmlRecordExporter implements IRecordExporter {
  protected static String nl;
  public static synchronized FriendHtmlRecordExporter create(String lineSeparator)
  {
    nl = lineSeparator;
    FriendHtmlRecordExporter result = new FriendHtmlRecordExporter();
    nl = null;
    return result;
  }
