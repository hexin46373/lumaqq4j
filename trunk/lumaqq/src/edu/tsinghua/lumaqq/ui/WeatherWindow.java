 ...
 * @author luma
 */
public class WeatherWindow extends BaseWindow implements IQQListener {
	...
	protected void onQuery() {		
		if(querying) {
			...
			expect = main.getClient().getWeather(ip);			
		}
	}
	...
	private void processGetWeatherSuccess(QQEvent e) {
		final WeatherOpReplyPacket packet = (WeatherOpReplyPacket)e.getSource();
