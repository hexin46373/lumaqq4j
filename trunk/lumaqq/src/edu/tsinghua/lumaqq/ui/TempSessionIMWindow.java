 ...
 * @author luma
 */
public class TempSessionIMWindow extends Window implements IQQListener, ShellListener, IFaceSelectionListener {    
    /**
     * <pre>
     * 闪烁图标
     * </pre>
     ...
     * @param parentShell
     */
    public TempSessionIMWindow(MainShell main, User f) {
        super(main.getShell());
        this.main = main;
        this.model = f;
