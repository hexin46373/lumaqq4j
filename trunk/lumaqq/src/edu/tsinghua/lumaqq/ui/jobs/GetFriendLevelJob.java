 ...
 * @author luma
 */
public class GetFriendLevelJob extends AbstractJob implements IQQListener {	
    ...
    private void request(int p) {
    	...
    	if(subList.isEmpty())
    		...
    		main.getClient().getFriendLevel(subList);
	}
    ...
    public void qqEvent(QQEvent e) {
        switch(e.type) {
            case QQEvent.QQ_GET_FRIEND_LEVEL_SUCCESS:
