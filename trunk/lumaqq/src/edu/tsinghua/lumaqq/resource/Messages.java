...
public class Messages extends NLS {
	...
	// 网络硬盘密码设置对话框
	public static String disk_password_set;
	public static String disk_password_cancel;
	public static String disk_password_old;
	public static String disk_password_new;
	public static String disk_password_confirm;
	
	// 网络硬盘相关文字
	public static String disk_tooltip_refresh;
	public static String disk_tooltip_download;
	public static String disk_tooltip_upload;
	public static String disk_tooltip_password;
	public static String disk_tooltip_rename;
	public static String disk_tooltip_delete;
	public static String disk_tooltip_new_directory;
	public static String disk_tooltip_set_share;
	public static String disk_my;
	public static String disk_shared_disk;
	public static String disk_my_doc;
	public static String disk_my_picture;
	public static String disk_my_multimedia;
	public static String disk_public;
	public static String disk_waiting;
	public static String disk_shared;
	public static String disk_not_finalized;
	public static String disk_hint_capacity;
	public static String disk_hint_get_shared_disk;
	public static String disk_hint_list_dir;
	public static String disk_hint_need_password;
	public static String disk_hint_timeout;
	public static String disk_hint_network_error;
	public static String disk_hint_auth_fail;
	public static String disk_hint_file;
	public static String disk_hint_set_password;
	public static String disk_hint_cancel_password;
	public static String disk_hint_fail;
	public static String disk_my_custom_head;
	public static String disk_my_custom_face;
	public static String disk_my_assistant;
	public static String disk_my_album;
	public static String disk_my_notebook;
	public static String disk_hint_input_password;
	public static String disk_my_favorite;
	public static String disk_hint_download_file;
	public static String disk_hint_cannot_open_file;
	public static String disk_hint_write_error;
	public static String disk_hint_read_error;
	public static String disk_hint_download_file_success;
	public static String disk_hint_download_file_abort;
	public static String disk_hint_abort;
	public static String disk_hint_abort_all;
	public static String disk_hint_rename;
	public static String disk_hint_rename_success;
	public static String disk_hint_input_new_name;
	public static String disk_hint_name_cannot_null;
	public static String disk_hint_delete;
	public static String disk_hint_confirm_delete;
	public static String disk_hint_cannot_delete_system_dir;
	public static String disk_hint_create;
	public static String disk_hint_move;
	public static String disk_hint_upload_file;
	public static String disk_hint_upload_file_abort;
	public static String disk_hint_get_share_list;
	public static String disk_hint_set_share_list;
	public static String disk_hint_disk_not_open;
	public static String disk_hint_apply_success;
	public static String disk_hint_apply;
	public static String disk_hint_do_you_want_to_apply;
	public static String disk_wulala;
	
	// 网络硬盘目录共享对话框
	public static String disk_share_title;
	public static String disk_share_set_share;
	public static String disk_hint_cannot_get_share_list;
	public static String disk_hint_cannot_set_share_list;
	public static String disk_hint_cannot_empty;
	public static String disk_hint_set_share_success;
