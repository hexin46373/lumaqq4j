...
public class OptionUtil {
	...
	public static final void save(File file, Options o) {
        ...
        resourceSet.getPackageRegistry().put(OptionPackage.eINSTANCE.getNsURI(), OptionPackage.eINSTANCE);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static final Options load(File file) {
        // Create a resource set.
        ResourceSet resourceSet = new ResourceSetImpl();
        ...
        try {
	        ...
	        if(resource.getContents().isEmpty())
	        	...
	        	return (Options) resource.getContents().get(0);
		} catch (IOException e) {
			return null;
		}
	}
	...
	public static final Options createDefault() {
		Options o = OptionFactory.eINSTANCE.createOptions();
		return o;
	}
}
