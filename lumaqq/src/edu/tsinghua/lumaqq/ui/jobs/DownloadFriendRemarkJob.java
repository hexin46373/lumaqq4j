 ...
 * @author luma
 */
public class DownloadFriendRemarkJob extends AbstractJob implements IQQListener {	
	// 备注工具类
	private int page;
    ...
    protected void preLoop() {
        ...
        main.getClient().batchDownloadFriendRemark(page++);
    }
    ...
    public void qqEvent(QQEvent e) {
        switch(e.type) {
            case QQEvent.QQ_BATCH_DOWNLOAD_FRIEND_REMARK_SUCCESS:
    ...
    private void processBatchDownloadFriendRemarkSuccess(QQEvent e) {
        ...
        if(packet.hasRemark) {
			for(Integer qq : packet.remarks.keySet()) {
                FriendRemark fr = (FriendRemark)packet.remarks.get(qq);
