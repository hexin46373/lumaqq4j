 ...
 * @author luma
 */
public class GetUserPropertyJob extends AbstractJob implements IQQListener {
    /* (non-Javadoc)
    ...
    protected void preLoop() {
        main.getClient().getUserProperty(QQ.QQ_POSITION_USER_PROPERTY_START);
    }
    ...
    public void qqEvent(QQEvent e) {
        switch(e.type) {
            case QQEvent.QQ_GET_USER_PROPERTY_SUCCESS:
    ...
    private void processGetUserPropertySuccess(QQEvent e) {
        ...
        if(packet.finished)
        	...
        	main.getClient().getUserProperty(packet.startPosition);
    }
