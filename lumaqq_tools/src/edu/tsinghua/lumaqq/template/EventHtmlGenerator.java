...
public class EventHtmlGenerator implements IGenerator {
  protected static String nl;
  public static synchronized EventHtmlGenerator create(String lineSeparator)
  {
    nl = lineSeparator;
    EventHtmlGenerator result = new EventHtmlGenerator();
    nl = null;
    return result;
  }
	...
	public String generate(Object argument)
  {
    ...
    stringBuffer.append( bean.info );
    stringBuffer.append(TEXT_14);
    stringBuffer.append( LINKED_PACKET );
    ...
    stringBuffer.append( RELATED_EVENT );
    stringBuffer.append(TEXT_24);
     if(bean.relatedEvents.isEmpty()) { 
    stringBuffer.append(TEXT_25);
    stringBuffer.append( NO_RELATED_EVENT );
    stringBuffer.append(TEXT_26);
     } else { 
    stringBuffer.append(TEXT_27);
     for(EventBean eb : bean.relatedEvents) {	
    stringBuffer.append(TEXT_28);
    stringBuffer.append( eb.html );
