 ...
 */
@DocumentalPacket
@PacketName("结束上传文件回复包")
@RelatedPacket({FinalizePacket.class})
@LinkedEvent({QQ_DISK_FINALIZE_SUCCESS})
public class FinalizeReplyPacket extends DiskInPacket {
	public long modifiedTime;

	public FinalizeReplyPacket(ByteBuffer buf, int length, QQUser user) throws PacketParseException {
		super(buf, length, user);
	}
	
	@Override
	public String getPacketName() {
		return "Finalize Reply Packet";
	}
