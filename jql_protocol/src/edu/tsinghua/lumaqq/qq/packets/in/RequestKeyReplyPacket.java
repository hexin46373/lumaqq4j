...
@DocumentalPacket
@PacketName("获取密钥回复包")
@RelatedPacket({RequestKeyPacket.class})
@LinkedEvent({QQ_REQUEST_KEY_SUCCESS, QQ_REQUEST_KEY_FAIL})
public class RequestKeyReplyPacket extends BasicInPacket {
    public byte[] key;
    public byte[] token;
     ...
     */
    public RequestKeyReplyPacket(ByteBuffer buf, int length, QQUser user) throws PacketParseException {
