 ...
 */
@DocumentalPacket
@PacketName("修改共享设置回复包")
@RelatedPacket({SetShareListPacket.class})
@LinkedEvent({QQ_DISK_SET_SHARE_LIST_SUCCESS})
public class SetShareListReplyPacket extends DiskInPacket {
	public long modifiedTime;
	
	public SetShareListReplyPacket(ByteBuffer buf, int length, QQUser user) throws PacketParseException {
		super(buf, length, user);
	}

	@Override
	public String getPacketName() {
		return "Set Share List Reply Packet";
	}
