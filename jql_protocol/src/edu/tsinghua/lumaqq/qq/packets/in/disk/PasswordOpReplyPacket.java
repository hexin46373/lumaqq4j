 ...
 */
@DocumentalPacket
@PacketName("网络硬盘密码操作回复包")
@RelatedPacket({PasswordOpPacket.class})
@LinkedEvent({QQ_DISK_PASSWORD_OP_SUCCESS, QQ_DISK_PASSWORD_OP_FAIL})
public class PasswordOpReplyPacket extends DiskInPacket {
	public PasswordOpReplyPacket(ByteBuffer buf, int length, QQUser user) throws PacketParseException {
		super(buf, length, user);
	}
	
	@Override
	public String getPacketName() {
		return "Password Op Reply Packet";
	}
