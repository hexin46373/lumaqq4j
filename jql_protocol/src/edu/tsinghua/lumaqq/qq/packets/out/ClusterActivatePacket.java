...
public class ClusterActivatePacket extends ClusterCommandPacket {
    /**
     * 构造函数
     */
    public ClusterActivatePacket(QQUser user) {
        super(user);
		subCommand = QQ.QQ_CLUSTER_CMD_ACTIVATE_CLUSTER;        
    }
     ...
     */
    public ClusterActivatePacket(ByteBuffer buf, int length, QQUser user)
            throws PacketParseException {
