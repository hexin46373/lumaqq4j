 ...
 */
@DocumentalPacket
@PacketName("获取中转服务器请求包")
@RelatedPacket({RequestAgentReplyPacket.class})
public class RequestAgentPacket extends _05OutPacket {
    ...
    /* (non-Javadoc)
     * @see edu.tsinghua.lumaqq.qq.packets._05OutPacket#getEncryptStart()
     */
	@Override
    protected int getCryptographStart() {
        return 14 + user.getFileAgentToken().length;
    }
