...
public class ClusterActivateTempPacket extends ClusterCommandPacket {
    private byte type;
     ...
     * 构造函数
     */
    public ClusterActivateTempPacket(QQUser user) {
        super(user);
		subCommand = QQ.QQ_CLUSTER_CMD_ACTIVATE_TEMP;
    }
     ...
     */
    public ClusterActivateTempPacket(ByteBuffer buf, int length, QQUser user)
            throws PacketParseException {
