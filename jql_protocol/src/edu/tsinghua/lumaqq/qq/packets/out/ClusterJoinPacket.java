...
public class ClusterJoinPacket extends ClusterCommandPacket {
	/**
	 * 构造函数
	 */
	public ClusterJoinPacket(QQUser user) {
		super(user);		
		subCommand = QQ.QQ_CLUSTER_CMD_JOIN_CLUSTER;
	}
     ...
     */
    public ClusterJoinPacket(ByteBuffer buf, int length, QQUser user)
            throws PacketParseException {
